...
class KolfGame {
    ...
    private aimDirection: number;
    private powerLevel: number;
    private isChargingPower: boolean;
    private powerChargeSpeed: number;
    private lastTime: number;
    private gameState: 'aiming' | 'shooting' | 'ballMoving' | 'completed' | 'trackSelect';
    ...
    private updatePowerMeter(): void {
        const powerBar = document.getElementById('power-bar') as HTMLElement;
    ...
    private checkWallCollision(wall: Wall): void {
    ...
    private checkLakeCollisions(): void {
    ...
    private checkSlopeEffects(): void {
